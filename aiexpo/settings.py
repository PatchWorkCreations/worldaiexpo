"""
Django settings for aiexpo project.
...
SECRET_KEY = 'django-insecure-*&&7-o5drl+bxli04jx9#j8g^gg^se)kl4oc!9y#6ueh(oy!9_'
...
EMAIL_BACKEND =EMAIL_BACKEND = os.getenv("EMAIL_BACKEND")
